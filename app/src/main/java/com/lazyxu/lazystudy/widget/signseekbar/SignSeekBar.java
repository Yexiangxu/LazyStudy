...
package com.lazyxu.lazystudy.widget.signseekbar;
...
public class SignSeekBar extends View {
    ...
    public SignSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.SignSeekBar_ssb_track_color, ContextCompat.getColor(context, com.lazyxu.base.R.color.colorAccent));
        mSecondTrackColor = a.getColor(R.styleable.SignSeekBar_ssb_second_track_color, ContextCompat.getColor(context, com.lazyxu.base.R.color.colorAccent));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(mThumbCenterX, yTop, SignUtils.dp2px(2), mPaint);
