...
class GalleryAdapter :
    ...
    override fun convert(holder: VBBaseViewHolder<ItemGalleryBinding>, item: VideoEntity) {
        ...
        ViewCompat.setTransitionName(holder.binding.ivGallery, "${context.getString(com.lazyxu.lib_common.R.string.video_share_element_imageview)}_${holder.layoutPosition}")
    }
}